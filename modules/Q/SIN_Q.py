...
def SIN_Q_f(radians: QNum) -> QNum:
    ...
    temp = x
    sin = x
    # Вычисляем синус, сохраняя результат факториалов, и используем их в дальнейшем.
    # Ряд Маклорена: x - x^3/3! + x^5/5! - x^7/7! и т.д. Начинаем сразу с x^3/3!
