...
def test_ROT_Q_H_pi_over_2_around_y():
...
def test_ROT_Q_H_negative_angle():
    axis_x = create_h(0, 1, 0, 0)
...
def test_ROT_Q_H_arbitrary_axis():
...
def test_ROT_Q_H_angle_doubling():
    axis_x = create_h(0, 1, 0, 0)
...
def test_ROT_Q_H_conjugate_inverse():
